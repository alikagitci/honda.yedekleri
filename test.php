...
$results = $wpdb->get_results( "
 ...
 SELECT a.sysmarka as aracmarka, b.sysaracmodel as aracmodel, e.sysurunanagrup as anagrup, f.sysurunaltgrup as altgrup
                FROM askdbyeni AS c
                ...
                WHERE  c.type='yedekparca' AND g.id <> 99999 AND d.id <> 99999 AND c.aracmarka='Honda'
                group by   a.sysmarka, b.sysaracmodel , e.sysurunanagrup, f.sysurunaltgrup
...
$aracMarka = 'Honda';
$aracModel = 'Accord';
$anaGrup = 'Elektrik Aksamları';
$altGrup = 'Sinyal Lambası';
...
foreach($results as $categories) {
    ...
    $aracMarka = $categories->aracmarka;
    $aracModel = $categories->aracmodel;
    $anaGrup = $categories->anagrup;
    $altGrup = $categories->altgrup;
